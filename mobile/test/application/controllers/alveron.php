...
class Alveron extends CI_Controller 
{
	...
	{
		$this -> form_validation -> set_rules ('userNameLogin','User Id','trim|required|xss_clean');
	...
	public function editUserStatus($userId,$userStatusId)
	{
		...
		if($userAccessValue)
		{
	   		...
	   		if($editSuccess>=0)
			{
				...
				$messageBody = 'Your account has been activated; please login to <a href="http://www.alveron.sg">Aleron Rate Chart Analysis</a> to continue.<br>';
			...
			foreach($userInfo as $list)
  			{
  				...
  				//echo 'mail send reason '.$mailSendReason;
		   		...
		   		)
		   		{
					...
					$config['smtp_host'] =  'mail.alveron.sg';//'ssl://smtp.gmail.com'; //'tls://smtp.gmail.com';
					$config['smtp_user'] =  'admin@alveron.sg';//'rates@alveron.sg';
					...
					$this-> email-> from('admin@alveron.sg','Rates Admin');
