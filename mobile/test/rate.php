...
<div class="wrapper">
   ...
   <!-- </div><!--/breadcrumbs-->
    ...
    <div class="container content" style="padding: 0px;">
		...
		<div class="col-md-4" style="height:259px;border:1px solid #ccc;background-color:rgb(245,239,235);border-bottom:0px;margin-top:-50px;padding-left:0px">
		...
		<div class="col-md-8" style="margin-top:-82px;z-index:999;position:relative;padding:0px;">
		...
		<div class="col-md-6" style="background-color:rgb(233,216,205);height:250px">
