...
left: 100%;"></span></dt>
				...
				<div style="margin:50px 120px;height:300px">
					<h2>View Rate
	<span style="font-size:16px;font-weight:normal;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="add_rate.php">Add Rate</a></span></h2>
	<hr/>
	<table>
		<tr>
			<td width="150px"><strong>Country Name</strong></td>
			<td width="150px"><strong>Rate</strong></td>
		...
		?>
		<tr>
			<td><strong><?php echo $value->country; ?></strong></td>
			<td><?php echo $value->rate; ?></td>
			<td><a href="edit_rate.php?id=<?php echo $i; ?>" style="text-decoration:none">Edit|</a>
			<a href="delete_rate.php?id=<?php echo $i; ?>" style="text-decoration:none"  onclick="return confirmDialog();">Delete</a></td>
		</tr>
		<?php 
			$i++;
			} 
		...
		<!---<tr>
			...
			<td>0.69/=</td>
			<td><a href="edit_rate.html" style="text-decoration:none">Edit|</a>
			<a href=" " style="text-decoration:none"  onclick="return confirmDialog();">Delete</a></td>
		</tr>
		<tr>
