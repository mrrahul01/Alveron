        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container" style="height:55px">
                ...
                <div class="navbar-header">
					...
					<a class="navbar-brand" href="http://alveron.sg/">
                      ...
                      <!--  <li class="active">
                        ...
                        <li class="dropdown">
							...
							<ul class="dropdown-menu">
                                <li><a href="whole_sale_voice.php">Whole Sale Voice</a></li>
                                <li><a href="dialer.php">Dialer</a></li>
                                <li><a href="retail.php">RETAIL VOICE</a></li>
                            </ul>
                        </li>
                        <!-- End Pages -->
